...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinDependency.Application.dll" comes first in this list. */
		"XamarinDependency.Application.dll",
		"XamarinDependency.LibraryBindings.dll",
